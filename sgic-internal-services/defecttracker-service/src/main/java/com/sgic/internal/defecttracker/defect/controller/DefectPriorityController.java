...
import com.sgic.internal.defecttracker.defect.controller.dto.mapper.DefectPriorityMapper;
...
public class DefectPriorityController {
	...
	public ResponseEntity<Object> updateDefectPriority(@RequestBody DefectPriorityDto defectPriorityDto, @PathVariable Long id) {
		BasicConfigurator.configure();
	...
	public ResponseEntity<Object> deleteDefectPriority(@PathVariable Long id, @RequestBody DefectPriorityDto defectPriorityDto) {
		BasicConfigurator.configure();
