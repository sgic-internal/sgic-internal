...
public class GetDefectPriorityByIdTest extends DefectPriorityAppTest{
	@Autowired
	...
	private static final String GET_DEFECT_PRIORITY_BY_ID = "{\"id\":2,\"name\":\"name2\",\"value\":\"value2\",\"icon\":\"icon2\",\"color\":\"color2\"}";

	// Testing for get defect priority by id
	@Test
	public void getDefectPriorityByIdTest() throws IOException, RestClientException {
		long id = 2;
		...
		assertEquals(GET_DEFECT_PRIORITY_BY_ID, response.getBody());
	}
